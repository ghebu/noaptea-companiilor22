...
echo "USAGE: source prepare.sh AWS_ACCESS_KEY AWS_SECRET_KEY module_name terraform_command"
echo "Example: source prepare.sh AWS_ACCESS_KEY AWS_SECRET_KEY 02-network apply"
